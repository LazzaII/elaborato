<?php
    ...
    $PALESTRA_FACILE_DB = "ideeinbi_palestrafacile";                                //nome DB
    $PALESTRA_FACILE_USER = "ideeinbi_palestrafacile";                                     //username
    $PALESTRA_FACILE_PASS = "palestrafacile2021";                                         //password
